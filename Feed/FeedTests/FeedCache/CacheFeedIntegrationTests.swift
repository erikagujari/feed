//
//  CacheFeedIntegrationTests.swift
//  FeedTests
//
//  Created by Erik Agujari on 2/3/21.
...
final class CacheFeedIntegrationTests: XCTestCase {
    override func setUp() {
        super.setUp()
    ...
    private func makeFeedLoader(file: StaticString = #file, line: UInt = #line) -> LocalFeedLoader {
        ...
        let store = try! CoreDataFeedStore(localURL: storeURL)
